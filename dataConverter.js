...
let llDataForReplacement = async function getllDataForReplacement(json) {
  ...
  json["TargetApplicationFakeDeviceToken"] = ["com.apple.test"];
  json["IPV4LAN"] =  randomip(randomLocalRouterIps[Math.floor(Math.random() * randomLocalRouterIps.length)],24);
  json["IPV6LAN"] = randomip('2001::4702:d9ff:feaf:6d48');
  json["IPV4CELL"] = randomip('132.12.34.12');
  json["IPV6CELL"] = randomip('2001::4702:d9ff:feaf:6d48');
